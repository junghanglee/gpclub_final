...
export const ADMIN_I18N = {
  ...
  totalProducts: { en: "Total registered", vi: "Tổng sản phẩm", ko: "총 등록 상품" },
  publishedProducts: { en: "Published", vi: "Đã xuất bản", ko: "퍼블리싱 상품" },
  searchResults: { en: "Filtered results", vi: "Kết quả lọc", ko: "검색 결과" },
  thumbnail: { en: "Image", vi: "Ảnh", ko: "이미지" },
  selected: { en: "selected", vi: "đã chọn", ko: "개 선택" },
  publishSelected: { en: "Publish", vi: "Xuất bản", ko: "선택 게시" },
  unpublishSelected: { en: "Unpublish", vi: "Hủy xuất bản", ko: "선택 게시 해제" },
  sortNewest: { en: "Newest / priority", vi: "Mới nhất / ưu tiên", ko: "최신 / 우선순위" },
  sortName: { en: "Product name", vi: "Tên sản phẩm", ko: "상품명 순" },
  sortBrand: { en: "Brand", vi: "Thương hiệu", ko: "브랜드 순" },
  catalogManagement: {
  ...
  catalogCoverImage: {
    en: "Catalog cover image",
    vi: "Ảnh bìa catalog",
    ko: "카탈로그 표지 이미지",
  },
  catalogCoverHint: {
    en: "Choose a product image or upload a separate cover.",
    vi: "Chọn ảnh sản phẩm hoặc tải ảnh bìa riêng.",
    ko: "상품 이미지 선택 또는 별도 표지 업로드",
  },
  chooseProductImage: { en: "Product image", vi: "Ảnh sản phẩm", ko: "상품 이미지" },
  uploadCoverImage: { en: "Upload from PC", vi: "Tải từ máy tính", ko: "PC에서 업로드" },
  catalogPreview: {
    en: "Cover preview and template",
  ...
  pageHeroImageHint: {
    en: "Paste a public image URL or upload a hero image. Leave blank to keep the route default.",
  ...
  chooseHeroImage: {
    en: "Choose hero image",
    vi: "Chọn ảnh hero",
    ko: "Choose hero image",
  },
  uploadingImage: {
    en: "Uploading...",
    vi: "Đang tải lên...",
  ...
  contentLanguage: {
    en: "Website content language",
    vi: "Ngôn ngữ nội dung website",
    ko: "Website content language",
  },
  vietnameseContent: {
    en: "Vietnamese",
    vi: "Tiếng Việt",
  ...
  englishContent: { en: "English", vi: "English", ko: "English" },
  compareTranslations: {
    en: "Compare translations",
    vi: "So sánh bản dịch",
    ko: "Compare translations",
  },
  editingScope: {
    en: "Editing scope",
    vi: "Phạm vi chỉnh sửa",
    ko: "Editing scope",
  },
  previewVietnamese: {
    en: "Preview Vietnamese",
    vi: "Xem trước tiếng Việt",
    ko: "Preview Vietnamese",
  },
  previewEnglish: {
    en: "Preview English",
    vi: "Xem trước tiếng Anh",
    ko: "Preview English",
  },
  saveScopeHint: {
    en: "Save affects",
  ...
  imageDetails: {
    en: "Image details (optional)",
    vi: "Thông tin ảnh (không bắt buộc)",
    ko: "Image details (optional)",
  },
  imageDetailsHint: {
    en: "Use this only when the image adds meaning that is not already explained by nearby text.",
    vi: "Chỉ nhập khi ảnh truyền tải ý nghĩa chưa có trong phần chữ xung quanh.",
    ko: "Use this only when the image adds meaning that is not already explained by nearby text.",
  },
  ...
  altVi: {
    en: "Image description VI",
    vi: "Mô tả ảnh VI",
    ko: "Image description VI",
  },
  altEn: {
    en: "Image description EN",
    vi: "Mô tả ảnh EN",
    ko: "Image description EN",
  },
  ...
  sectionImageHint: {
    en: "Add a public image URL or upload a section image.",
    vi: "Thêm URL ảnh công khai hoặc tải ảnh cho section.",
    ko: "Add a public image URL or upload a section image.",
  },
  chooseSectionImage: {
    en: "Choose section image",
    vi: "Chọn ảnh section",
    ko: "Choose section image",
  },
  brandPositioningSection: {
    en: "Brand positioning",
    vi: "Định vị thương hiệu",
    ko: "Brand positioning",
  },
  brandCoreValuesSection: {
    en: "Core values",
    vi: "Giá trị cốt lõi",
    ko: "Core values",
  },
  brandCardsSection: {
    en: "Strategic brand cards",
    vi: "Thẻ thương hiệu chiến lược",
    ko: "Strategic brand cards",
  },
  brandAdvisorSection: {
    en: "AI advisor block",
    vi: "Khối cố vấn AI",
  ...
  b2bBrandSection: {
    en: "B2B brand sales content",
    vi: "Nội dung bán hàng thương hiệu B2B",
    ko: "B2B brand sales content",
  },
  b2bProcessSection: {
    en: "B2B launch process",
    vi: "Quy trình ra mắt B2B",
    ko: "B2B launch process",
  },
  b2bImageSpacesSection: {
    en: "B2B image spaces",
    vi: "Không gian hình ảnh B2B",
    ko: "B2B image spaces",
  },
  b2bContactSection: {
    en: "B2B contact intro",
    vi: "Giới thiệu liên hệ B2B",
    ko: "B2B contact intro",
  },
  gippyGuideSection: {
    en: "Gippy guide content",
    vi: "Nội dung hướng dẫn Gippy",
    ko: "Gippy guide content",
  },
  gippySuggestionSection: {
    en: "Gippy suggestion cards",
    vi: "Thẻ gợi ý Gippy",
    ko: "Gippy suggestion cards",
  },
  gippyQuickActionSection: {
    en: "Gippy quick actions",
    vi: "Hành động nhanh Gippy",
    ko: "Gippy quick actions",
  },
  gippyStatsSection: {
    en: "Gippy stat labels",
    vi: "Nhãn thống kê Gippy",
    ko: "Gippy stat labels",
  },
  advisorImage: { en: "Advisor image", vi: "Ảnh cố vấn", ko: "Advisor image" },
  imageAlt: {
    en: "Image description",
    vi: "Mô tả ảnh",
    ko: "Image description",
  },
  headline: { en: "Headline", vi: "Tiêu đề", ko: "Headline" },
  quote: { en: "Quote", vi: "Trích dẫn", ko: "Quote" },
  label: { en: "Label", vi: "Nhãn", ko: "Label" },
  processStep: { en: "Process step", vi: "Bước quy trình", ko: "Process step" },
  askLabel: { en: "Ask label", vi: "Nhãn hỏi", ko: "Ask label" },
  prompt: { en: "Prompt", vi: "Gợi ý nhập", ko: "Prompt" },
